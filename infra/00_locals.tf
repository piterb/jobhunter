locals {
  ...
  neon_db_branch_name       = trimspace(var.neon_db_branch_name) != "" ? trimspace(var.neon_db_branch_name) : "main"
  neon_should_create_branch = trimspace(var.neon_db_branch_name) != ""
